    ...
    const promise = new Promise(async (resolve, reject) => {
      try {
        ...
        if (file) {
          ...
          const imgResponse = await axios.post(`${import.meta.env.VITE_API_URL}/api/image`, formData);
        ...
        await axios.post(`${import.meta.env.VITE_API_URL}/api/submit-form`, currentData);
        setPushData({
          mcdata: "",
          bgdetail: "",
          bgdate: "",
